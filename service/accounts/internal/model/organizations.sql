...
CREATE TABLE `procurements` (
  ...
  `currency_id` int(11) DEFAULT NULL,
  `currency_value` decimal(15,5) DEFAULT NULL,
  ...
  `payment_discount` decimal(20,5) DEFAULT NULL,
  `shipment_method_id` int(11) DEFAULT NULL,
  ...
  `transport_method_id` int(11) DEFAULT NULL,
  `entry_point_id` int(11) DEFAULT NULL,
  `campaign_id` int(11) DEFAULT NULL,
  `area_id` int(11) DEFAULT NULL,
  `vendor_shipment_no` varchar(255) DEFAULT NULL,
  `subtotal_exclusive_vat` decimal(20,5) DEFAULT NULL,
  `total_discount` decimal(20,5) DEFAULT NULL,
  `total_exclusive_vat` decimal(20,5) DEFAULT NULL,
  `total_vat` decimal(20,5) DEFAULT NULL,
  `total_inclusive_vat` decimal(20,5) DEFAULT NULL,
  `subtotal_exclusive_vat_lcy` decimal(20,5) DEFAULT NULL,
  `total_discount_lcy` decimal(20,5) DEFAULT NULL,
  `total_exclusive_vat_lcy` decimal(20,5) DEFAULT NULL,
  `total_vat_lcy` decimal(20,5) DEFAULT NULL,
  `total_inclusive_vat_lcy` decimal(20,5) DEFAULT NULL,
  PRIMARY KEY (`id`) /*T![clustered_index] CLUSTERED */
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;


-- bynar.procurement_lines definition
...
CREATE TABLE `procurement_lines` (
  ...
  `tax_area_id` int(11) DEFAULT NULL,
  `vat_id` int(11) DEFAULT NULL,
  `quantity_assign` decimal(15,5) DEFAULT NULL,
  `quantity_assigned` decimal(15,5) DEFAULT NULL,
  `subtotal_exclusive_vat` decimal(20,5) DEFAULT NULL,
  `total_discount` decimal(20,5) DEFAULT NULL,
  `total_exclusive_vat` decimal(20,5) DEFAULT NULL,
  `total_vat` decimal(20,5) DEFAULT NULL,
