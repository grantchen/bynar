...
func (s *approvalCashPaymentService) Check(tr *treegrid.MainRow, moduleID, accountID int) (bool, error) {
...
func (s *approvalCashPaymentService) checkActionAdded(tr *treegrid.MainRow, moduleID, accountID int) (bool, error) {
...
func (s *approvalCashPaymentService) checkActionUpdated(tr *treegrid.MainRow, moduleID, accountID int) (bool, error) {
